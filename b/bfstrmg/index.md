...
6.  folgende im Fahrzeuggerät gespeicherte Daten:
    ...
    e)  wenn ein Fahrzeuggerät verwendet wird, das auf Mikrowellentechnik im Sinne des § 2 Nummer 3 des Mautsystemgesetzes basiert, folgende Daten:
        ...
        aa) den aktuellen Betriebszustand, die letzten drei vorangegangenen Betriebszustände sowie den Zeitpunkt und den Ort des jeweiligen Wechsels des Betriebszustandes,
    ...
    f)  wenn ein Fahrzeuggerät verwendet wird, das nicht auf Mikrowellentechnik im Sinne des § 2 Nummer 3 des Mautsystemgesetzes basiert, folgende Daten:
        ...
        aa) alle Betriebszustände, die zum Zeitpunkt der Kontrolle nicht älter als zehn Stunden sind, sowie den Zeitpunkt und den Ort des jeweiligen Wechsels des Betriebszustandes,


        bb) alle Daten zur Fahrzeugklasse, zur technisch zulässigen Gesamtmasse und zur Anzahl der Achsen des Fahrzeugs, die jeweils zum Zeitpunkt der Kontrolle nicht älter als zehn Stunden sind, sowie
