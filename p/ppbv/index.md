...
*    *
    *
    *
    *   **Wäschewechsel**                        (Kleidung und Bettwäsche) **und Teilkörperwaschungen** **mindestens 2 x täglich**
...
*    *
    ...
    *   **Hochaufwendiger Lagerungswechsel**                        (bzw. Mikrolagerung) **mindestens 10 x täglich**
...
*    *
    *
    *
    *   **Mindestens 8 x tägl. hochaufwendiger Lagerungs-/Positionswechse**                       l oder Mobilisation
...
*    *   F
    ...
    *   Kommunikation findet Berücksichtigung in den allgemeinen Leistungsstufen KA1 und KA2. Erst ab Leistungsstufe KA3 findet eine gesonderte Berücksichtigung statt
...
*    *
    ...
    *   **45 Minuten tägl.**                        (Summe kann addiert werden) geplante spezifische Information/Anleitung/
[^F830285_05_BJNR0BC0A0024BJNE002600000]
        Beratung
        mit Leistungsnachweis, inkl. Vor- und Nachbereitung; die Betreuung findet gesondert/getrennt von anderen Interventionen statt
...
*    *
    ...
    *   Eins-zu-eins-Betreuung: Einen Patienten kontinuierlich über einen längeren Zeitraum                         von mind.
...
*    *
    ...
    *   Eins-zu-eins-Betreuung: Einen Patienten kontinuierlich über einen längeren Zeitraum von **mind. 60 Min. tägl**                       . (Summe kann addiert werden) in Präsenz betreuen und getrennt/gesondert von anderen Interventionen stattfindet, bei Vorliegen eines der in der Beispielliste aufgeführten Gründe
...
*    *
    *
    *
    *   **Hochaufwendige kommunikative Stimulation**                       , Förderung der spielerischen Interaktion, Bereitstellen und Nachbereitung von Lektüre, Spiel-,
        Mal-                        und Bastelmaterial von **mind. 60 Min. tägl**                       . (Summe kann addiert werden), die getrennt von anderen Interventionen bei Vorliegen eines der in der Liste aufgeführten Gründe stattfindet
...
*    *
    ...
    *
    *   **Hochaufwendige kommunikative Stimulation**                       , Förderung der spielerischen Interaktion, Bereitstellen und Nachbereitung von Lektüre, Spiel-,
        Mal-                        und Bastelmaterial von **mind. 60 Min. tägl**                       . (Summe kann addiert werden) und getrennt von anderen Interventionen bei Vorliegen eines der in der Liste aufgeführten Gründe
...
[^F830285_02_BJNR0BC0A0024BJNE002600000]:     kontinuierlicher O             2             -Bedarf (z. B. O             2             -Brille) um die O             2             -Sättigung über 92 % zu halten
    altersabhängig, z. B.: einzelne Schritte, Bewegungsablauf
[^F830285_03_BJNR0BC0A0024BJNE002600000]:     altersabhängig, z. B.: Festigung der Muskulatur, viele Schritte, Automatisierung
...
*    *   F, K und J
    ...
    *   Alle Patienten, die nicht der Leistungsstufe KS2, KS3 oder KS4 zugeordnet werden
...
*    *
    ...
    *   Vitalzeichenkontrolle und Krankenbeobachtung mit Erhebung von **mindestens 24 Parametern**                       \* täglich
...
*    *
   ...
   **Vitalzeichenkontrolle**
        **und Krankenbeobachtung**                        zum Erkennen einer akuten Bedrohung fortlaufend innerhalb von 24 Stunden, z. B.:
...
*    *
    ...
    *   **Vitalzeichenkontrolle**
        **und Krankenbeobachtung**                        zum Erkennen einer akuten Bedrohung fortlaufend innerhalb von 24 Stunden **bei Zeichen einer respiratorischen Beeinträchtigung oder**                        bei Vorhandensein eines Tracheostomas und bei Vorliegen eines Erschwernisfaktors (siehe Beispielliste):
...
*    *
    ...
    *   **Zu mindestens neun verschiedenen Uhrzeiten Verabreichung der Arzneimittel**                       , die der Patient nicht selbständig einnehmen kann, bei massiver Abwehr/Widerständen/Uneinsichtigkeit bei der Verabreichung von Arzneimitteln **oder**                        massiver Beeinträchtigung der oralen Arzneimitteleinnahme durch Bewusstseinseinschränkung **und**                        hochaufwendiges (komplexes) Arzneimittelregime entsprechend ärztlicher Anordnung mit hoher Verabreichungsfrequenz oder Multimedikation
...
*    *
    ...
    *   **Vor- und Nachbereiten und Assistieren bei aufwendigem Verbandswechsel oder**                        Assistenz bei Entfernung von einer Drainage **oder**                        einem ZVK etc.
...
*    *
    ...
    *   Eines der unter KS2 genannten Kriterien **mindestens 2 x täglich** **oder**                        durch 2 PFK
...
*    *   F, K, J
    ...
    *   Begleitung findet Berücksichtigung in den allgemeinen Leistungsstufen KS1, KS2 und KS3. Erst ab Leistungsstufe KS4 findet eine gesonderte Berücksichtigung statt.
...
*    *
    ...
    *   **Fortlaufendes Beobachten und Betreuen (1:1) des Patienten**                        durch eine PFK bei Maßnahmen/
...
[^F830285_06_BJNR0BC0A0024BJNE002700000]:     z. B. Kontrolle von:               06:00 Uhr: Puls, Atmung               08:00 Uhr: Gewicht, Puls, Atmung, RR, BZ, Temp               10:00 Uhr: Puls, Atmung               12:00 Uhr: Puls, Atmung, BZ               14:00 Uhr: Puls, Atmung               18:00 Uhr: Puls, Atmung, BZ, Temp               22:00 Uhr: Puls, Atmung               02:00 Uhr: Puls, Atmung,Temp
...
*    *   **2. Leistungen im Zusammenhang mit der Beatmung/CPAP (inkl. Vor- und Nachbereitung)**
    ...
    *   Invasiv beatmeter Patient bei instabiler Beatmungssituation (Beatmung mit z. B. OI*                        25)
...
*    *   3. Leistungen im Zusammenhang mit medikamentöser Versorgung (z. B.: iv,
    ...
    *   Kreislauf instabiler Patient (mit z. B. wechselnder Katecholamin-/Kreislauftherapie, Katecholamin-DTI*                        2 Katecholamine)
...
*    *   **5. Übergeordnete Einstufungskriterien**
    ...
    *   Alle Patienten, die nicht der Leistungsstufe IS2 oder IS3 zugeordnet werden
