...
2.4.2 Elektrische Beschaffenheit
    ...
    17 – Zündmaschinen müssen kräftige Anschlussklemmen mit unverlierbaren Muttern haben. Die Anschlussklemmen dürfen keinen hohlen Querschnitt haben und müssen aus Messing mit einer Zugfestigkeit von mindestens 400 N/mm
    2                    bestehen. Der Durchmesser der Halteschraube muss mindestens 4 mm und der der Anschlussschraube mindestens 6 mm betragen. Sie müssen gegen zufällige Berührung unter Spannung stehender Teile gesichert sein.
...
1.  Die Vorschriften dieser Anlage gelten für Sprengstoffe, die
    ...
    a)  aus einem oder mehreren einheitlichen brisanten Sprengstoffen zusammengesetzt sind, die in ihrer reinen Form einen Dampfdruck von weniger als 0,0001 Pa bei einer Temperatur von 25
        Grad C haben,
...
3.3 Schutzabstand bei vertikalem Verwenden und Windgeschwindigkeiten von*                      9 m/s
...
3.3.8 bei Gegenständen, deren nach den Ziffern 3.3.2 bis 3.3.7 ermittelte Schutzabstände kleiner sind als der Abstand ihrer seitlich weggeschleuderten Reststücke:
...
3.4.3 Beim Verwenden von Feuerwerkskörpern unter einem Neigungswinkel von der Senkrechten ist der nach den Ziffern 3.3.2 bis 3.3.4, 3.3.8, 3.4.1 und 3.4.2 ermittelte Schutzabstand in Abhängigkeit des Neigungswinkels von der Senkrechten in Neigungsrichtung folgendermaßen zu vergrößern:
...
3.4.4 Bei Windgeschwindigkeiten > 9 m/s sind die nach den Ziffern 3.3.2 bis 3.3.9 und 3.4.1 bis 3.4.3 ermittelten Schutzabstände in Windrichtung folgendermaßen zu vergrößern:
...
4.2 Schutzabstände bei vertikaler Verwendung und bei Windgeschwindigkeiten*                      9 m/s
...
4.2.3 Der größere Wert der beiden Schutzabstände S
    ...
    B                    bestimmen den resultierenden Schutzabstand in die jeweilige Richtung.
